...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pass.equals(rpass) && mail.equals(rmail)) {
            ...
            u.put("username", request.getParameter("txtAccount"));
            u.put("password", request.getParameter("txtPassword"));
            u.put("email", request.getParameter("txtEmail"));
            DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            u.put("joindate", dateFormat.format(new Date()));
